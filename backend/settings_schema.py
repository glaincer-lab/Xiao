...
SCHEMA: list[dict] = [
    ...
    {"path": "_guide.tts.cloud", "label": "引导", "type": "guide", "group": "tts",
     "guide": "付费云 TTS（CosyVoice v3 / Qwen-Audio-TTS）：音质比 edge-tts 更自然、可选专属音色。\n复用阿里云百炼的 DASHSCOPE_API_KEY（.env），无需单独填 Key。\n档位：flash 快省钱，plus 音质更好（CosyVoice plus 仅 2 个音色）。"},
