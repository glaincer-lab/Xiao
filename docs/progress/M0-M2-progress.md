...
python -m unittest tests.test_attention tests.test_m3_budget tests.test_m3_heartbeat tests.test_m3_aggregate tests.test_m3_event_trigger tests.test_m3_dormant tests.test_m3_anniversary tests.test_m3_style tests.test_m3_shadow tests.test_m4_session tests.test_m4_outfit tests.test_m4_gaze tests.test_m4_feedback tests.test_m5_ha tests.test_m5_approval tests.test_m5_scene tests.test_m5_vlm tests.test_m5_trip  # M3-M0..M5-M5 增量: 22+25+20+24+32+9+6+10+8+6+4+7+6+3+7+5
