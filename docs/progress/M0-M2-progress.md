...
>
> **注意**：本页为 **M0-M2 详细子模块基线**；M0-M5 完整进度与全量测试审计基线见 [`M0-M5-progress.md`](M0-M5-progress.md)。本页「M0 121 / M1 116 / M2 115 = 352」为 **M0-M2 核心计数**；全量（含 T7/T8/gateway 等其他模块）实测 **815**，口径见 M0-M5-progress.md §一。
