...
**长期愿景**：助手、朋友、家人。帮你干活，也记得你的成长、陪你度过低落、在合适的时候先开口——一个由程序实现的陪护人，而不是一个听话的工具。

## 我们的三条产品哲学

这是小二一切设计决策的出发点：

1. **记忆要像家人的记性**——记得住、容得下变化、从不拿记忆跟你对质。对细节学会健忘，对情绪保持深刻。
2. **主动但克制**——没有记忆的主动是骚扰，有记忆的主动才是家人。所有主动开口收口在一个总闸门，说废话不如沉默。
...
隐私与安全是家人感的地基：摄像头默认关、观察帧会话结束即焚、出网内容过安全网关（人名混淆、敏感词不出网）、记忆本地存储可随时导出删除。详见路线图 §1.5。
