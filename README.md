...
- **出网安全网关**：所有云调用的强制前置层——敏感词本机拦截、人名占位混淆、还原校验（部分混淆：人名混淆仅覆盖已登记高频实体，长尾明文出网属个人自用豁免，详见网关说明）
...
| 出网安全网关 | M0 | 所有云调用前置：黑词本机拦截、人名占位混淆出云、还原校验（部分混淆：长尾明文出网，个人自用豁免） | — |
...
隐私与安全是伙伴感的地基：摄像头默认关、观察帧会话结束即焚、出网内容过安全网关（敏感词本机拦截、人名混淆；注意：人名混淆仅覆盖已登记的高频实体，首次出现的陌生人名可能明文出网，可在设置中补充映射）、记忆本地存储可随时导出删除。详见路线图 §1.5。
